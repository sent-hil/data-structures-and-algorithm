# Heap implementation taken fromhttps://github.com/florian/rb_heap/blob/master/lib/rb_heap/heap.rb
class Heap
  def initialize(storage = [], &compare_fn)
    @heap = storage
    @size = 0
    initialize_compare(&compare_fn)
  end
